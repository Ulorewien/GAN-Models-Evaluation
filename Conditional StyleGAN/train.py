...
from generator import StyledGenerator
from discriminator import Discriminator
from utils import requires_grad, accumulate, get_data_sample, adjust_lr
        ...
        if (i + 1) % 100 == 0:
            ...
            with torch.no_grad():
                for _ in range(gen_i):
                    images.append(g_running(torch.randn(gen_j, code_size).cuda(), step=step, alpha=alpha).data.cpu())
